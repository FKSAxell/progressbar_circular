...
import 'package:progressbar_circular/src/widgets/radial_progress.dart';
        ...
        children: [
          Row(
            ...
            children: [
              ...
              CustomRadiaProgress(porcentaje: porcentaje, color: Colors.red, gradiente: gradiente,),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: [
              ...
              CustomRadiaProgress(porcentaje: porcentaje, color: Colors.purple),
            ],
          )
        ],
      )
